...
class Edit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    prd.nameController.text = name;
    prd.ageController.text = address;
    prd.medicinesController.text = medicines;
    prd.addressController.text = age;
    prd.selectedImage = imagePath != '' ? File(imagePath) : null;
